...
def claim_free_ebook():
    ...
    parser.add_argument("--download", action="store_true", help="download ebook")
...
@env_variables_required(["PACKTPUB_EMAIL", "PACKTPUB_PASSWORD", "PACKTPUB_BOOKS_DIR"])
